...
func TestExporter_New(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			exporter, err := newLogsExporter(zap.NewNop(), test.config, context.TODO())
			if exporter != nil {
				defer func() {
...
func newTestExporter(t *testing.T, url string, fns ...func(*Config)) *elasticsearchLogsExporter {
	exporter, err := newLogsExporter(zaptest.NewLogger(t), withTestExporterConfig(fns...)(url), context.TODO())
